namespace Word_to_Markdown
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "Click the below button to convert the selected Word document into a Markdown file. At " +
    "the end of the process, an option will be provided to view the generated file.";
            ...
            this.button1.Text = "Convert to Markdown";
