#region Copyright Syncfusion Inc. 2001 - 20019
//
...
namespace EssentialXlsIOSamples
{
    ...
    public class FormatCells : MetroForm
    {
        ...
        private void btnCreate_Click(object sender, System.EventArgs e)
        {
            ...
            if (this.rdbExcel97.Checked)
                worksheet.Pictures.AddPicture(10, 3, imagePath, 66, 63);
            else
            {
                IPictureShape picture = worksheet.Pictures.AddPicture(10, 3, imagePath);
