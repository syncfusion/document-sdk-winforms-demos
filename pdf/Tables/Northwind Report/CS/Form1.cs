...
namespace EssentialPDFSamples
{
    ...
    public class Form1 : MetroForm
    {
        ...
        public Form1()
        {
            ...
            this.comboBox1.Location = new Point(comboBox1.Location.X, comboBox1.Location.Y + 5);
    ...
    "";
        ...
        private void builtinstyles_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                this.button1.Location = new Point(450, 220);
            ...
            {
            this.builtinstyles.Location = new Point(3, 180);
            this.builtinstyles.Size = new Size(80, 17);
            this.button1.Location = new Point(450, 450);
